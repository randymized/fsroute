...
var FSRoute= function(root,roadmap)
{
  ...
  FSRoute.prototype.composable_middleware= function (next) {
    new RequestHandler(this,next).descend();
  }

  FSRoute.prototype.composable_error_handler= function (next) {
    new RequestHandler(this,next,err).descend();
  }

  FSRoute.prototype.connect_middleware= function (req,res,next) {
      composable_middleware(FSRoute.prototype.composable_middleware)(req,res,next)
  }

  FSRoute.prototype.connect_error_handler= function (req,res,next) {
      composable_middleware(FSRoute.prototype.composable_error_handler)(req,res,err,next)
  }

  FSRoute.prototype.RequestHandler= RequestHandler
}
