...
var FSRouteFactory= function(root,roadmap)
{
  ...
  var composable_middleware_fn= FSRouteFactory.composable_middleware= function (next) {
    new RequestHandler(this,next).descend();
  }
  FSRouteFactory.connect_middleware= function (req,res,next) {
    composable_middleware([composable_middleware_fn])(req,res,next)
  }
  var composable_error_handler= FSRouteFactory.composable_error_handler= function (err,next) {
    new RequestHandler(this,next,err).descend();
  }
  FSRouteFactory.connect_error_handler= function (req,res,err,next) {
