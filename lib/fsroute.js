...
var FSRouteFactory= function(root,roadmap)
{
  ...
  var composable_middleware_fn= RequestHandler.composable_middleware= function (next) {
    new RequestHandler(this,next).descend();
  }
  RequestHandler.connect_middleware= function (req,res,next) {
    composable_middleware([composable_middleware_fn])(req,res,next)
  }
  var composable_error_handler= RequestHandler.composable_error_handler= function (err,next) {
    new RequestHandler(this,next,err).descend();
  }
  RequestHandler.connect_error_handler= function (req,res,err,next) {
